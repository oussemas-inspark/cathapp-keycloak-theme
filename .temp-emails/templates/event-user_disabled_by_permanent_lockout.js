...
// emails/templates/event-user_disabled_by_permanent_lockout.tsx
...
var templateName = "User Disabled by Permanent Lockout";
var { exp: exp2 } = createVariablesHelper2("event-user_disabled_by_permanent_lockout.ftl");
var Template = ({ locale, t }) => {
  ...
  return /* @__PURE__ */ jsxs2(
    EmailLayout,
    {
      ...
      locale,
      children: [
        /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-user_disabled_by_permanent_lockout.message", {
          date: exp2("event.date")
        }) }),
        /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-user_disabled_by_permanent_lockout.contactAdmin") })
      ]
    }
  );
};
...
//# sourceMappingURL=event-user_disabled_by_permanent_lockout.js.map
