...
// emails/templates/event-update_totp.tsx
...
var templateName = "Update OTP";
var { exp: exp2 } = createVariablesHelper2("event-update_totp.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("event-update_totp.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-update_totp.message", {
      date: exp2("event.date"),
      ipAddress: exp2("event.ipAddress")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-update_totp.contactAdmin") })
  ] });
};
...
//# sourceMappingURL=event-update_totp.js.map
