...
// emails/templates/event-login_error.tsx
...
var templateName = "Login Error";
var { exp: exp2 } = createVariablesHelper2("event-login_error.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("event-login_error.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-login_error.message", {
      date: exp2("event.date"),
      ipAddress: exp2("event.ipAddress")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-login_error.contactAdmin") })
  ] });
};
...
//# sourceMappingURL=event-login_error.js.map
