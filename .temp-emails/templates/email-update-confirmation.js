...
// emails/templates/email-update-confirmation.tsx
...
var templateName = "Email Update Confirmation";
var { exp: exp2 } = createVariablesHelper2("email-update-confirmation.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("email-update-confirmation.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-update-confirmation.updateEmailAddress", {
      realmName: exp2("realmName"),
      newEmail: exp2("newEmail")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-update-confirmation.clickLinkBelow") }),
    /* @__PURE__ */ jsx2(
      Button,
      {
        width: 200,
        ...
        fontSize: 15,
        href: exp2("link"),
        children: t("email-update-confirmation.updateEmail")
      }
    ),
    ...
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-update-confirmation.ignoreMessage") })
  ] });
};
...
//# sourceMappingURL=email-update-confirmation.js.map
