...
// emails/templates/event-remove_credential.tsx
...
var templateName = "Remove Credential";
var { exp: exp2 } = createVariablesHelper2("event-remove_credential.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("event-remove_credential.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-remove_credential.message", {
      credentialType: exp2('event.details.credential_type!"unknown"'),
      date: exp2("event.date"),
      ipAddress: exp2("event.ipAddress")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-remove_credential.contactAdmin") })
  ] });
};
...
//# sourceMappingURL=event-remove_credential.js.map
