...
// emails/templates/identity-provider-link.tsx
...
var templateName = "Identity Provider Link";
var { exp: exp2 } = createVariablesHelper2("identity-provider-link.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("identity-provider-link.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("identity-provider-link.message", {
      identityProviderDisplayName: exp2("identityProviderDisplayName"),
      realmName: exp2("realmName"),
      username: exp2("identityProviderContext.username")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("identity-provider-link.clickLink") }),
    /* @__PURE__ */ jsx2(
      Button,
      {
        width: 200,
        ...
        fontSize: 15,
        href: exp2("link"),
        children: t("identity-provider-link.linkAccountsButton")
      }
    ),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("identity-provider-link.linkExpiration", {
      expiration: exp2("linkExpirationFormatter(linkExpiration)")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("identity-provider-link.ignoreMessage") }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("identity-provider-link.loginInfo", {
      identityProviderDisplayName: exp2("identityProviderDisplayName"),
      realmName: exp2("realmName")
    }) })
  ] });
...
//# sourceMappingURL=identity-provider-link.js.map
