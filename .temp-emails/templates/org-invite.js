...
// emails/templates/org-invite.tsx
...
var templateName = "Org Invite";
var { exp: exp2, v } = createVariablesHelper2("org-invite.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("org-invite.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: /* @__PURE__ */ jsx2(Fm.If, { condition: `${v("firstName")}?? && ${v("lastName")}??`, children: /* @__PURE__ */ jsx2("p", { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("org-invite.greeting", {
      firstName: exp2("firstName"),
      lastName: exp2("lastName")
    }) }) }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("org-invite.message", { organizationName: exp2("organization.name") }) }),
    /* @__PURE__ */ jsx2(
      Button,
      {
        width: 200,
        ...
        fontSize: 15,
        href: exp2("link"),
        children: t("org-invite.joinButton")
      }
    ),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("org-invite.linkExpiration", {
      expiration: exp2("linkExpirationFormatter(linkExpiration)")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("org-invite.ignoreMessage") })
  ] });
};
