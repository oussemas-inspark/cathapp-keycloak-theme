...
// emails/templates/event-update_password.tsx
...
var templateName = "Update Password";
var { exp: exp2 } = createVariablesHelper2("event-update_password.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("event-update_password.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-update_password.message", {
      date: exp2("event.date"),
      ipAddress: exp2("event.ipAddress")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-update_password.contactAdmin") })
  ] });
};
...
//# sourceMappingURL=event-update_password.js.map
