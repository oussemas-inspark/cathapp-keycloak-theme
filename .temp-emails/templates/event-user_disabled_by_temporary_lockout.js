...
// emails/templates/event-user_disabled_by_temporary_lockout.tsx
...
var templateName = "User Disabled by Temporary Lockout";
var { exp: exp2 } = createVariablesHelper2("event-user_disabled_by_temporary_lockout.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(
    EmailLayout,
    {
      preview: t("event-user_disabled_by_temporary_lockout.subject"),
      locale,
      children: [
        /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-user_disabled_by_temporary_lockout.message", {
          date: exp2("event.date")
        }) }),
        /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-user_disabled_by_temporary_lockout.contactAdmin") })
      ]
    }
  );
};
...
//# sourceMappingURL=event-user_disabled_by_temporary_lockout.js.map
