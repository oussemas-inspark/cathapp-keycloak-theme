...
import { Button, Link, render, Text as Text2 } from "jsx-email";
...
var templateName = "Email Test";
var { exp: exp2 } = createVariablesHelper2("email-test.ftl");
...
var Template = ({ locale, t }) => {
  ...
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: "Here is a preview", locale, children: [
    /* @__PURE__ */ jsxs2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: [
      t("email-test.greeting"),
      " oussema,"
    ] }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-test.passwordUpdate", { date: formattedDate }) }),
    /* @__PURE__ */ jsxs2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: [
      t("email-test.passwordReset"),
      " ",
      /* @__PURE__ */ jsx2(Link, { href: "#", style: link, children: t("email-test.passwordReset") }),
      " ",
      t("email-test.passwordReset")
    ] }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-test.passwordAdvice") }),
    /* @__PURE__ */ jsx2(
      Button,
      {
        width: 200,
        ...
        children: t("email-test.loginButton")
      }
    ),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-test.contactSupport", { realmName: exp2("realmName") }) }),
    /* @__PURE__ */ jsxs2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: [
      t("email-test.thanks"),
      ",",
      /* @__PURE__ */ jsx2("br", {}),
      t("email-test.supportTeam", { realmName: exp2("realmName") })
    ] })
  ] });
};
