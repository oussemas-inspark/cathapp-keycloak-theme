...
// emails/templates/event-update_credential.tsx
import i18n2 from "i18next";
import { Text as Text2, render } from "jsx-email";
...
var templateName = "Update credential";
var { exp: exp2 } = createVariablesHelper2("event-update_credential.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("event-update_credential.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-update_credential.message", {
      credentialType: exp2('event.details.credential_type!"unknown"'),
      date: exp2("event.date"),
      ipAddress: exp2("event.ipAddress")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-update_credential.contactAdmin") })
  ] });
};
...
//# sourceMappingURL=event-update_credential.js.map
