...
var { exp: exp2 } = createVariablesHelper2("email-verification.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("email-verification.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-verification.message", { firstName: exp2("user.firstName") }) }),
    /* @__PURE__ */ jsx2(
      Button,
      {
        width: 200,
        ...
        fontSize: 15,
        href: exp2("link"),
        children: t("email-verification.verifyButton")
      }
    ),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-verification.linkExpiration", {
      expiration: exp2("linkExpirationFormatter(linkExpiration)")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-verification.ignoreMessage") })
  ] });
};
