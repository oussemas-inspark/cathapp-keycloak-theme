...
// emails/templates/executeActions.tsx
import i18n2 from "i18next";
import { Button, Raw, Text as Text2, render } from "jsx-email";
...
var EmailLayout = ({
  ...
  return /* @__PURE__ */ jsxs(Html, { lang: locale, dir: locale === "ar" ? "rtl" : "ltr", children: [
    ...
    /* @__PURE__ */ jsx(Body, { style: main, children: /* @__PURE__ */ jsxs(Container, { style: container, children: [
      /* @__PURE__ */ jsx(Section, { style: logo, children: /* @__PURE__ */ jsx(Img, { width: 200, src: companyLogo }) }),
      ...
      /* @__PURE__ */ jsx(Section, { style: footer, children: /* @__PURE__ */ jsx(Row, { children: /* @__PURE__ */ jsxs(Text, { style: { textAlign: "center", color: "#706a7b" }, children: [
...
var templateName = "ExecuteActions";
var { exp: exp2 } = createVariablesHelper2("executeActions.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("executeActions.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Raw, { content: "<#assign isHospitalCode=false />" }),
    /* @__PURE__ */ jsx2(Raw, { content: "<#if requiredActions?? && (requiredActions?size == 1) && (requiredActions[0] == 'verify-hospital-code')>" }),
    /* @__PURE__ */ jsx2(Raw, { content: "<#assign isHospitalCode=true />" }),
    /* @__PURE__ */ jsx2(Raw, { content: "<#assign subjectKey='verifyHospitalCodeSubject' />" }),
    /* @__PURE__ */ jsx2(Raw, { content: "<#else>" }),
    /* @__PURE__ */ jsx2(Raw, { content: "<#assign subjectKey='executeActions.subject' />" }),
    /* @__PURE__ */ jsx2(Raw, { content: "</#if>" }),
    /* @__PURE__ */ jsx2(Raw, { content: "<#if isHospitalCode>" }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("verifyHospitalCodeBody", {
      0: exp2("user.firstName")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("verifyHospitalCodeMessage") }),
    /* @__PURE__ */ jsx2(
      "div",
      {
        style: codeBox,
    ...
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("verifyHospitalCodeInstructions") }),
    /* @__PURE__ */ jsx2(
      Button,
      {
        width: 220,
        ...
        fontSize: 15,
        href: exp2("link"),
        children: t("verifyHospitalCodeButton")
      }
    ),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("email-update-confirmation.linkExpiration", {
      expiration: exp2("linkExpirationFormatter(linkExpiration)")
    }) }),
    /* @__PURE__ */ jsx2(Raw, { content: "<#else>" }),
    /* @__PURE__ */ jsxs2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: [
      t("executeActions.message", { realmName: exp2("realmName") }),
      /* @__PURE__ */ jsx2(Raw, { content: "<#assign requiredActionsText><#if requiredActions??><#list requiredActions><#items as reqActionItem>${msg('requiredAction.${reqActionItem}')}<#sep>, </#sep></#items></#list></#if></#assign>" })
    ] }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("executeActions.clickLink") }),
    /* @__PURE__ */ jsx2(
      Button,
      {
        width: 200,
        ...
        fontSize: 15,
        href: exp2("link"),
        children: t("executeActions.updateAccountButton")
      }
    ),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("executeActions.linkExpiration", {
      expiration: exp2("linkExpirationFormatter(linkExpiration)")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("executeActions.ignoreMessage") }),
    /* @__PURE__ */ jsx2(Raw, { content: "</#if>" })
  ] });
};
