...
// emails/templates/event-remove_totp.tsx
...
var templateName = "Remove OTP";
var { exp: exp2 } = createVariablesHelper2("event-remove_totp.ftl");
var Template = ({ locale, t }) => {
  const isRTL = locale === "ar";
  return /* @__PURE__ */ jsxs2(EmailLayout, { preview: t("event-remove_totp.subject"), locale, children: [
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-remove_totp.message", {
      date: exp2("event.date"),
      ipAddress: exp2("event.ipAddress")
    }) }),
    /* @__PURE__ */ jsx2(Text2, { style: applyRTL(paragraph, isRTL, rtlStyle), children: t("event-remove_totp.contactAdmin") })
  ] });
};
...
//# sourceMappingURL=event-remove_totp.js.map
